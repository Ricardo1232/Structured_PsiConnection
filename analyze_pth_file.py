...
ruta_modelo_original = "model/modelo_trastornos.pth"  # Cambia la ruta si es necesario

# Cargar el modelo
modelo = torch.load(ruta_modelo_original, map_location=torch.device('cpu'), weights_only=True)
