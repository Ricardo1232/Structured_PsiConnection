...
if __name__ == "__main__":
    ...
    generar_multiples_predicciones(n=15)  # Generar 15 predicciones
    
    print("\n\n Diferentes")
    respuestas =  [2]*35
    mostrar_respuestas_y_predicciones(respuestas, predecir_trastornos(respuestas))
    print("\n\n ")
    respuestas =   [0]*35
    mostrar_respuestas_y_predicciones(respuestas, predecir_trastornos(respuestas))
    print("\n\n")
    ...
    print("\n\n")
    respuestas = [2]*5 + [1]*5 + [0]*5 + [1]*5 + [1,2,0,1,2]*3
    mostrar_respuestas_y_predicciones(respuestas, predecir_trastornos(respuestas))
    print("\n\n")
    respuestas = [2]*5 + [1]*5 + [0,0,0,1,2]*3 + [0]*5 + [1]*5 
    mostrar_respuestas_y_predicciones(respuestas, predecir_trastornos(respuestas))
    print("\n\n")
